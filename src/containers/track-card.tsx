...
import { humanReadableTimeFromSeconds, Spread } from "../utils/helpers";
import { Link } from 'react-router-dom'
import type { Track } from '../__generated__/graphql'
import { useMutation } from "@apollo/client";
import { gql } from "../__generated__";

type _Track = Spread<Omit<Track, "modules">, {
  author: Omit<Track["author"], "id">;
}>
 ...
 */
const TrackCard: React.FC<{ track: _Track }> = ({ track }) => {
